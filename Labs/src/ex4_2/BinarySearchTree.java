   ...
   implements SortedSet<E>
{
   ...
   {  // create the binary search tree
     ...
     System.out.println("rotated left Tree: " + tree);
     tree.rightRotationOfRoot();
     System.out.println("rotated back right Tree: " + tree);
     tree.rightRotationOfRoot();
     System.out.println("rotated right again Tree: " + tree);
     tree.rightRotationOfRoot();
     System.out.println("rotated back right again: " + tree);
     tree.leftRotationOfRoot();
     tree.leftRotationOfRoot();
     System.out.println("rotated left twice: " + tree);
